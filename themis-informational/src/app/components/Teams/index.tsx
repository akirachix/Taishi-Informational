const teamMembers = [
  { name: 'Patricia Ainembabazi', role: 'Software developer', image: '/patricia.jpg' },
  { name: 'Nancy Nabacwa', role: 'Software developer', image: '/nancy.png' },
  { name: 'Pearl Cheshari', role: 'Software developer', image: '/pearl.png' },
  { name: 'Lavender Anyango', role: 'Software developer', image: '/lavender.jpg' },
  { name: 'Latifah Umunyana', role: 'Software developer', image: '/latifa.png' },
];

function TeamSection() {
  return (
    <section className="bg-white font-josefin py-0 xl:px-18">
